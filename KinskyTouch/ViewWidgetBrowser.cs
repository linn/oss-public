...
{
    [MonoTouch.Foundation.Register("ViewWidgetBrowser")]
    partial class ViewWidgetBrowser : UITableViewController, IViewWidgetContent
    {
        ...
        private class DataSource : UITableViewDataSource, IContentHandler, IDataSource
        {
            ...
            public override int RowsInSection(UITableView aTableView, int aSection)
            {
                lock(iLockObject)
                {
                    return iSectionRowCount[aSection];
                }
            }
            ...
            public override string TitleForHeader(UITableView aTableView, int aSection)
            {
                lock(iLockObject)
                {
                    ...
                    return iSectionTitles[aSection];
                }
            }

            public override int SectionFor(UITableView aTableView, string aTitle, int aAtIndex)
            {
                return aAtIndex;
            }
        ...
        private class Delegate : UITableViewDelegate, IDisposable
        {
            ...
            public override float GetHeightForRow(UITableView aTableView, NSIndexPath aIndexPath)
            {
        ...
        public override void ViewDidLoad()
        {
            ...
            UISearchBar searchBar = new UISearchBar(new RectangleF(0, 0, TableView.Frame.Width, 0));
            ...
            {
                TableView.SetContentOffset(new PointF(0, searchBar.Frame.Height), false);
            }
        ...
        void EventImageAdded(object sender, ArtworkCache.EventArgsArtwork e)
        {
        ...
        public void Open()
        {
            lock(this)
            {
                if(iLocation != null)
                {
                    ...
                    IContainer container = iLocation.Current;
                    container.EventContentAdded += ContentChanged;
                    container.EventContentRemoved += ContentChanged;
                    container.EventContentUpdated += ContentChanged;
                    ...
                    gesture = new UILongPressGestureRecognizer(this, new MonoTouch.ObjCRuntime.Selector("LongPressGesture"));
                    gesture.MinimumPressDuration = 1.0f;
                    gesture.Delegate = new LongPressGestureDelegate();
        ...
        protected void OnLongPressGesture(UILongPressGestureRecognizer aRecogniser)
        {
            ...
            {
                PointF point = aRecogniser.LocationInView(tableView);
                ...
                if(path != null)
                {
                    ...
                    viewWidgetBrowser.OpenActionSheet(sheet, tableView.RectForRowAtIndexPath(path), tableView);
        ...
        protected virtual void OpenActionSheet(UIActionSheet aActionSheet, RectangleF aRect, UITableView aTableView)
        {
    ...
    partial class ViewWidgetBrowserRoot : ViewWidgetBrowser
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            iViewHourGlass.Frame = new RectangleF(0.0f, 44.0f, NavigationController.View.Frame.Width, NavigationController.View.Frame.Height - 88.0f);
        ...
        public void Initialise(Location aRootLocation, PlaySupport aPlaySupport, ConfigController aConfigController, OptionEnum aOptionInsertMode, OptionBreadcrumbTrail aOptionBreadcrumbTrail)
        {
            ...
            iRetrys = 5;
            iLocatorAsync = new LocatorAsync(aRootLocation.Current, iOptionBreadcrumbTrail.BreadcrumbTrail);
    ...
    partial class ViewWidgetBrowserRootIpad : ViewWidgetBrowserRoot
    {
        ...
        protected override void OpenActionSheet(UIActionSheet aActionSheet, RectangleF aRect, UITableView aTableView)
        {
    ...
    partial class ViewWidgetBrowserRootIphone : ViewWidgetBrowserRoot
    {
        ...
        protected override void OpenActionSheet(UIActionSheet aActionSheet, RectangleF aRect, UITableView aTableView)
        {
            ...
            aActionSheet.ShowFrom(new RectangleF(0, aTableView.Frame.Bottom - 10, aTableView.Superview.Frame.Width, 10), aTableView.Superview, true);
        }
