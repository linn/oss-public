...
namespace KinskyTouch
{
    internal class ViewWidgetPlaylistMediaRenderer : IViewWidgetPlaylist, IControllerPlaylistMediaRenderer
    {
        ...
        {
            public Delegate(IControllerPlaylistMediaRenderer aControllerPlaylistMediaRenderer, List<Item> aItems)
            {
                iControllerPlaylistMediaRenderer = aControllerPlaylistMediaRenderer;
                iItems = aItems;
            }
        ...
        public void Close()
        {
            lock(this)
            {
                iTableView.BeginInvokeOnMainThread(delegate {
                    ...
                    iTableView.Delegate = new ViewWidgetPlaylistMediaRenderer.Delegate(this, new List<Item>());
            ...
            iTableView.BeginInvokeOnMainThread(delegate {
                lock(this)
                {
                    if(iOpen)
                    {
                        ...
                        iTableView.DataSource = iDataSource;
                        iTableView.Delegate = new ViewWidgetPlaylistMediaRenderer.Delegate(this, items);
                        iTableView.ReloadData();
    ...
    internal class ViewWidgetPlaylistRadio : IViewWidgetPlaylistRadio, IControllerPlaylistRadio
    {
        ...
        private class Delegate : UITableViewDelegate
        {
            public Delegate(IControllerPlaylistRadio aControllerPlaylistRadio)
            {
            ...
            IControllerPlaylistRadio iControllerPlaylistRadio;
        }
        ...
        public void Close()
        {
            lock(this)
            {
                iTableView.BeginInvokeOnMainThread(delegate {
                    ...
                    iTableView.DataSource = iDataSource;
                    iTableView.Delegate = new ViewWidgetPlaylistRadio.Delegate(this);
                    iTableView.ReloadData();
    ...
    internal class ViewWidgetPlaylistDiscPlayer : IViewWidgetPlaylistDiscPlayer
    {
        ...
        public void Open()
        {
            iImageView.BeginInvokeOnMainThread(delegate {
    ...
    internal class ViewWidgetPlaylistReceiver : IViewWidgetPlaylistReceiver, IViewWidgetSelector<Linn.Kinsky.Room>, IControllerPlaylistReceiver, IControllerRoomSelector
    {
        ...
        private class Delegate : UITableViewDelegate
        {
            public Delegate(DataSource aDataSource, IControllerPlaylistReceiver aController)
            {
        ...
        void IViewWidgetPlaylistReceiver.Close()
        {
            lock(this)
            {
                iTableView.BeginInvokeOnMainThread(delegate {
                    ...
                    iTableView.DataSource = iDataSource;
                    iTableView.Delegate = new Delegate(iDataSource, this);
                    iTableView.ReloadData();
                ...
                if(iSenders != null && aChannel != null)
                {
                    foreach(ModelSender s in iSenders)
                    {
                        foreach(resource r in s.Metadata[0].Res)
                        {
                            ...
                            {
                                iSender = s;
                                if(!iRooms.TryGetValue(s.Room, out iSenderRoom))
                                {
                                    iSenderRoom = null;
                                }
                                break;
        ...
        private Linn.Kinsky.Room iSenderRoom;
