...
namespace KinskyTouch
{
    ...
    public partial class UIViewControllerKinskyTouchIphone : UIViewController
    {
        ...
        public override bool ShouldAutorotateToInterfaceOrientation(UIInterfaceOrientation aToInterfaceOrientation)
        {
            if(aToInterfaceOrientation == UIInterfaceOrientation.Portrait || aToInterfaceOrientation == UIInterfaceOrientation.PortraitUpsideDown)
            {
                return true;
            }
            else
    ...
    public partial class UIViewControllerNowPlaying : UIViewController
    {
        ...
        private void ListClicked(object sender, EventArgs e)
        {
            if(iNowPlaying)
            {
                UIView.Transition(imageViewArtwork, viewPlaylist, 1.0f, UIViewAnimationOptions.TransitionFlipFromLeft, null);
                UIView.Transition(buttonList, buttonArtwork, 1.0f, UIViewAnimationOptions.TransitionFlipFromLeft, null);
                iNowPlaying = false;
            }
            else
            {
                UIView.Transition(viewPlaylist, imageViewArtwork, 1.0f, UIViewAnimationOptions.TransitionFlipFromRight, null);
                UIView.Transition(buttonArtwork, buttonList, 1.0f, UIViewAnimationOptions.TransitionFlipFromRight, null);
                iNowPlaying = true;
            }
        }
