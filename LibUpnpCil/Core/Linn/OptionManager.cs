            ...
            if (!migrated)
            {
                ...
                if (File.Exists(Path.Combine(dataPath, "KinskyDesktop.xml")))
                {
                    try
                    {
                        ...
                        iLoadDictionary["background"] = ((int.Parse(doc.SelectSingleNode("/KinskyDesktop/BackgroundColour/A").InnerText) << 24) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/BackgroundColour/R").InnerText) << 16) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/BackgroundColour/G").InnerText) << 8) | int.Parse(doc.SelectSingleNode("/KinskyDesktop/BackgroundColour/B").InnerText)).ToString();
                        iLoadDictionary["highlight"] = ((int.Parse(doc.SelectSingleNode("/KinskyDesktop/HighlightColour/A").InnerText) << 24) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/HighlightColour/R").InnerText) << 16) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/HighlightColour/G").InnerText) << 8) | int.Parse(doc.SelectSingleNode("/KinskyDesktop/HighlightColour/B").InnerText)).ToString();
                        iLoadDictionary["text"] = ((int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextColour/A").InnerText) << 24) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextColour/R").InnerText) << 16) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextColour/G").InnerText) << 8) | int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextColour/B").InnerText)).ToString();
                        iLoadDictionary["textmuted"] = ((int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextMutedColour/A").InnerText) << 24) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextMutedColour/R").InnerText) << 16) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextMutedColour/G").InnerText) << 8) | int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextMutedColour/B").InnerText)).ToString();
                        iLoadDictionary["textbright"] = ((int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextBrightColour/A").InnerText) << 24) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextBrightColour/R").InnerText) << 16) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextBrightColour/G").InnerText) << 8) | int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextBrightColour/B").InnerText)).ToString();
                        iLoadDictionary["texthighlighted"] = ((int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextHighlightColour/A").InnerText) << 24) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextHighlightColour/R").InnerText) << 16) | (int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextHighlightColour/G").InnerText) << 8) | int.Parse(doc.SelectSingleNode("/KinskyDesktop/TextHighlightColour/B").InnerText)).ToString();
                        int i = int.Parse(doc.SelectSingleNode("/KinskyDesktop/FontPreset").InnerText);
                        switch (i)
                        {
                            case 0:
