...
namespace KinskyTouch
{
    ...
    {
        public ViewRotaryBar(RectangleF aRect)
            : base(aRect)
        {
            iFontSize = 15.0f;
    ...
    [MonoTouch.Foundation.Register("UIControlWheel")]
    partial class UIControlWheel : UIControl
    {
        ...
        public override void Draw(RectangleF rect)
        {
            ...
            iImageWheel.Draw(new RectangleF(0.0f, 0.0f, Frame.Width, Frame.Height), CGBlendMode.Normal, 1.0f);
        }
    ...
    [MonoTouch.Foundation.Register("UIControlRocker")]
    partial class UIControlRocker : UIControlWheel, IControlRotary
    {
        ...
        public override void Draw(RectangleF rect)
        {
            ...
            {
                iImageOverLeft.Draw(new RectangleF(0.0f, 0.0f, Frame.Width, Frame.Height), CGBlendMode.Normal, 1.0f);
            }
            if(iTouchBeganLocation == UIControlRocker.ETouch.eRight)
            {
                iImageOverRight.Draw(new RectangleF(0.0f, 0.0f, Frame.Width, Frame.Height), CGBlendMode.Normal, 1.0f);
            }

            iImageGrip.Draw(new RectangleF(0.0f, 0.0f, Frame.Width, Frame.Height), CGBlendMode.Normal, 1.0f);
        ...
        {
            PointF point = aTouch.LocationInView(this);

            if(Bounds.Contains(point))
            {
                float x = point.X - (Frame.Width * 0.5f);
                float y = point.Y - (Frame.Height * 0.5f);
    ...
    [MonoTouch.Foundation.Register("UIControlRotary")]
    partial class UIControlRotary : UIControlWheel, IControlRotary
    {
        ...
        public override void Draw(RectangleF rect)
        {
            ...
            if((iTouchedInner && !iOutsideInner) || (iTouchedOuter && !iOutsideOuter))
            {
                if(iImageOver != null)
                {
                    iImageOver.Draw(new RectangleF(0.0f, 0.0f, Frame.Width, Frame.Height), CGBlendMode.Normal, 1.0f);
                }
            }
        ...
        private void UpdateAngle(PointF aPoint)
        {
            // get the current mouse angle
        ...
        private float CalculateMouseAngle(PointF aPtInView)
        {
        ...
        private PointF Centre
        {
            get
            {
                return new PointF(Frame.Width * 0.5f, Frame.Height * 0.5f);
            }
        }
        ...
        private float iInnerRadius;
        private float iOuterRadius;
    ...
    partial class ViewHourGlass : UIView
    {
        ...
        public override void Draw(RectangleF rect)
        {
            ...
            if(iStarted)
            {
                iImageBuffering.Draw(new PointF((Frame.Width - iImageBuffering.Size.Width) * 0.5f, (Frame.Height - iImageBuffering.Size.Height) * 0.5f), CGBlendMode.Normal, 1.0f);
                ...
                iImageBufferingElement.Draw(new PointF((Frame.Width - iImageBufferingElement.Size.Width) * 0.5f, (Frame.Height - iImageBufferingElement.Size.Height) * 0.5f), CGBlendMode.Normal, 1.0f);
