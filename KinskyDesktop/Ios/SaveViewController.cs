        ...
        class DataSource : UITableViewDataSource
        {
            internal class ImageTableViewCell : UITableViewCell
            {
                ...
                public override void LayoutSubviews ()
                {
                    ...
                    float margin = 15;
                    iImageView.Frame = new System.Drawing.RectangleF(115, margin * 0.5f, ContentView.Frame.Height - margin, ContentView.Frame.Height - margin);
                }

                private UIImageView iImageView;
            }

            internal class Delegate : NSUrlConnectionDelegate
            {
