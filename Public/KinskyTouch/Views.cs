...
namespace KinskyTouch
{
	internal class ViewWidgetTransportControl : IViewWidgetTransportControl
	{
		...
		public void Close()
		{
			lock(this)
			{
                iButtonLeft.BeginInvokeOnMainThread(delegate {
        ...
        {
            iButtonCentre.BeginInvokeOnMainThread(delegate {
    ...
    internal class ViewWidgetPlayMode : IViewWidgetPlayMode
    {
        ...
        public void Close()
        {
            lock(this)
            {
                iButtonShuffle.BeginInvokeOnMainThread(delegate {
        ...
        public void SetRepeat(bool aRepeat)
        {
            lock(this)
            {
                iButtonRepeat.BeginInvokeOnMainThread(delegate {
