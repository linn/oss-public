...
namespace Linn.ControlPoint.Upnp
{
    ...
    */
    ...
    public abstract class ServiceUpnp : Linn.ControlPoint.Service
    {
        ...
        {
            string message = String.Format("{0}: ServiceUpnp.HandleSubscriptionException - Device:{1}, SubscriptionId:{2}, ServiceType:{3}, Method:{4}, Exception:{5}", DateTime.Now, Device.Udn, iSubscriptionId, Type, aMethodName, aException);
