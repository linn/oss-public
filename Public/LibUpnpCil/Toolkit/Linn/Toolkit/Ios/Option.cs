...
namespace Linn.Toolkit.Ios
{
    public class OptionPageAbout : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            imageView.Frame = new RectangleF(85, 20, 150, 150);
            ...
            label = new UILabel(new RectangleF(0, 180, 320, 20));
            ...
            label = new UILabel(new RectangleF(0, 200, 320, 20));
            label.TextAlignment = UITextAlignment.Center;
            ...
            label = new UILabel(new RectangleF(0, 220, 320, 20));
            label.TextAlignment = UITextAlignment.Center;
        ...
        private class DataSource : UITableViewDataSource
        {
            private class CellEditable : UITableViewCell
            {
                public CellEditable(UITableViewCellStyle aStyle, string aReUseIdentifier)
                    : base(aStyle, aReUseIdentifier)
                {
                    RectangleF rect = new RectangleF(ContentView.Bounds.Location, ContentView.Bounds.Size);
