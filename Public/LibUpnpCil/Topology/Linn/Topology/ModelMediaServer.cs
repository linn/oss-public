        ...
        public ModelMediaServer(MediaServer aMediaServer, IEventUpnpProvider aEventServer)
        {
            ...
            if (title != null)
            {
                ...
                foreach (XmlNode i in icons)
                {
                    ...
                    try
                    {
                        int w = (widthNode != null) ? int.Parse(widthNode.InnerText) : 0;
                        int h = (heightNode != null) ? int.Parse(heightNode.InnerText) : 0;
                        int d = (depthNode != null) ? int.Parse(depthNode.InnerText) : 0;
