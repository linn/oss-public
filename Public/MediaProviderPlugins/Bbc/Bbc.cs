...
namespace OssKinskyMppBbc
{
    ...
    internal class ListenShow : IComparable
    {
        ...
        private void UpdateMetadata(bool aUk)
        {
            ...
            if (aUk)
            {
                audioUri = "http://www.bbc.co.uk/mediaselector/4/asx/" + iProgramId + "/iplayer_intl_stream_wma_uk_concrete";
            }
            else
            {
                audioUri = "http://www.bbc.co.uk/mediaselector/4/asx/" + iProgramId + "/iplayer_intl_stream_wma_lo_concrete";
            }
