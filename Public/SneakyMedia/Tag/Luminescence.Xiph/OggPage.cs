...
namespace Luminescence.Xiph
{
   ...
   public class OggPage : IEquatable<OggPage>
   {
      ...
      public bool IsComplete
      {
         get
         {
            return (segments[segments.Length - 1].Length < 255);
         }
      }
      ...
      public bool IsLastInLogicalBitstream
      {
         get
         {
            return (headerType == OggHeaderType.ContinuedPaquetInLastLogicalBitstream ||
      ...
      public int PageSequenceNumber
      {
         ...
         protected set { pageSequenceNumber = value; }
      }

      private OggHeaderType? headerType;
      /// <summary>
      /// Type de la page Ogg.
      /// </summary>
      /// <remarks>Returne null si sa valeur n'est pas renseignée</remarks>
      public OggHeaderType? HeaderType
      {
         get { return headerType; }
         protected set { headerType = value; }
      }

      private long absoluteGranulePostion;
      /// <summary>
      /// Absolute Granule Position.
      /// </summary>
      public long AbsoluteGranulePostion
      {
         get { return absoluteGranulePostion; }
         protected set { absoluteGranulePostion = value; }
      }
      ...
      public int StreamSerialNumber
      {
         ...
         protected set { streamSerialNumber = value; }
      }
      ...
      protected void ComputeCRC32()
      {
         ...
         {
            crc32 = (crc32 << 8) ^ crc_lookup[((crc32 >> 24) & 255) ^ page[i]];
         }
      ...
      public static OggPage[] CreateFromPaquet(byte[] paquet, int streamSerial)
      {
         ...
         {
            byte[] newPaquet = new byte[paquet.Length + 1];
         ...
         int nbPage = (int)Math.Ceiling((double)segments.Length / (double)maxSegmentByPage);

         OggPage[] pages = new OggPage[nbPage];
         int offset = 0;
         ...
         for (int i = 0; i < pages.Length; i++)
         {
            ...
            ArraySegment<byte[]> seg = new ArraySegment<byte[]>(segments, offset, nbSegments);
            offset += seg.Count;
            ...
            page.streamSerialNumber = streamSerial;
            page.segments = data;
            page.headerType = i == 0 ? OggHeaderType.FreshPaquetInContinuedLogicalBitstream : OggHeaderType.ContinuedPaquetInContinuedLogicalBitstream;
            pages[i] = page;
         }
      ...
      /// <returns>True si les deux pages Ogg sont identiques, sinon False</returns>
      public static bool operator ==(OggPage page1, OggPage page2)
      {
