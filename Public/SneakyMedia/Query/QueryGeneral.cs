...
{
    public class ModuleQueryGeneral : ModuleQuery
    {
        public ModuleQueryGeneral()
            : base ("General", new Version(1, 0, 0, 0))
        {
        }
        ...
        public override IList<IList<string>> Query(List<string> aQuery)
        {
            ...
            while (list.MoveNext())
            {
                ...
                else if (clause == "WHERE")
                {
                    ...
                    ITag tag = new TagGeneral(list.Current);
                ...
                else if (clause == "SHOW")
                {
                    ...
                    show.Add(new TagGeneral(list.Current));
                }
                else
                {
