    ...
    internal class MediatorRoom
    {
        ...
        private void InsertModelRoom(int aIndex, Room aRoom)
        {
            ...
            if (iModelSelectorRoom.Selected == null)
            {
                if (iAutoSelect)
                {
                    if (iStartupRoom.Value == aRoom.Name || (iStartupRoom.Value == OptionStartupRoom.kLastSelected && (iLastSelectedRoom.Value == aRoom.Name || iLastSelectedRoom.Value == string.Empty)))
                    {
                        iAutoSelect = false;
                        SelectRoom(aRoom);
